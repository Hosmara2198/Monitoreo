            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>El scrap de página permitirá obtener información general de cualquier
                        ...
                        <img src="{{ asset('imagen/apps/aliasFacebook.png') }}" alt="FaceBook" style="width: 90%">
                        </br></br></br></br>

                        <b>ID de la página</b>
                        </br>
                        <img src="{{ asset('imagen/apps/idFacebook.png') }}" alt="FaceBook"
                        ...
                        <img src="{{ asset('imagen/apps/ejemploId.png') }}" alt="FaceBook"
                             style="width: 90%; vertical-align: middle">
                        </br></br>
